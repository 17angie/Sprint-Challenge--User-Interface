...
Semantic HTML gives meaning to the content on a web page. It explains to developers what each section contains.
...
It allows multiple people to work on a project without commiting to the changes.

5. Define mobile-first design in your own words.

A mobile first site was devoloped to fit a mobile screen first.
